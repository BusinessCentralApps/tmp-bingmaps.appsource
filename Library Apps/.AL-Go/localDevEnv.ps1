...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/microsoft/AL-Go/Actions/ecbbde1e146bc26fa6e7aef790bcafe87e72ab2d/Github-Helper.psm1' -folder $tmpFolder -notifyAuthenticatedAttempt
$ReadSettingsModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/microsoft/AL-Go/Actions/ecbbde1e146bc26fa6e7aef790bcafe87e72ab2d/.Modules/ReadSettings.psm1' -folder $tmpFolder
$debugLoggingModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/microsoft/AL-Go/Actions/ecbbde1e146bc26fa6e7aef790bcafe87e72ab2d/.Modules/DebugLogHelper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/microsoft/AL-Go/Actions/ecbbde1e146bc26fa6e7aef790bcafe87e72ab2d/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/microsoft/AL-Go/Actions/ecbbde1e146bc26fa6e7aef790bcafe87e72ab2d/.Modules/settings.schema.json' -folder $tmpFolder | Out-Null
DownloadHelperFile -url 'https://raw.githubusercontent.com/microsoft/AL-Go/Actions/ecbbde1e146bc26fa6e7aef790bcafe87e72ab2d/Environment.Packages.proj' -folder $tmpFolder | Out-Null
